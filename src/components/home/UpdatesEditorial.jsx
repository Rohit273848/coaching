  ...
  return (
    <section className="py-16 lg:py-24 bg-[#F8F7F4] border-b border-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div className="space-y-2 max-w-2xl">
            ...
            <p className="text-sm text-slate-600 font-normal">
              Stay informed on batch commencement dates, scholarship tests, and examination updates.
            </p>
          </div>
        ...
        {/* Magazine Layout: 1 Large Featured Story (7 cols) + 2 Compact Stories (5 cols) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 bg-white rounded-2xl border border-stone-300/80 overflow-hidden shadow-sm flex flex-col justify-between group">
            <div className="relative aspect-16/9 bg-slate-900 overflow-hidden">
              <img
                ...
                loading="lazy"
              />
              <span className="absolute top-3 left-3 bg-[#8B1E26] text-white text-[10px] font-extrabold px-2.5 py-1 rounded uppercase tracking-wider">
            ...
            <div className="p-6 sm:p-8 space-y-3 flex-1 flex flex-col justify-between">
              <div className="space-y-2">
                ...
                <h3 className="text-xl sm:text-2xl font-extrabold text-[#0F2038] tracking-tight leading-snug">
                  {featured.title}
                </h3>
              ...
              <div className="pt-4 border-t border-stone-100 flex items-center justify-between">
                <button
                  ...
                  className="text-xs font-extrabold text-[#8B1E26] hover:text-[#6D171E] flex items-center gap-1.5"
                >
          ...
          {/* 2 Compact Stories (5 cols) */}
          <div className="lg:col-span-5 flex flex-col justify-between gap-5">
            {secondary.map((item) => (
              <div
                key={item.id}
                className="bg-white rounded-xl border border-stone-300/80 p-5 sm:p-6 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-3"
              >
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-extrabold uppercase tracking-wider text-[#0F2038] bg-stone-100 px-2 py-0.5 rounded">
                      {item.category}
                    </span>
                ...
                <div className="pt-3 border-t border-stone-100">
                  <button
                    ...
                    className="text-xs font-bold text-[#8B1E26] hover:underline flex items-center gap-1"
                  >
