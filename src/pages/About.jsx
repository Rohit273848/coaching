    ...
    <div className="py-6 sm:py-12 bg-[#F8F7F4] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
          <div className="lg:col-span-7 space-y-3.5 sm:space-y-4">
            ...
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
              We started with just 25 students in Samarth Nagar. Over the past 15 years, our commitment to small batch sizes (35 max) and daily doubt resolution has produced over 1,450+ selections in IITs, NITs, AIIMS, and top government engineering & medical colleges.
            </p>
            <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal">
            ...
            <div className="pt-2 grid grid-cols-1 xs:grid-cols-2 gap-2.5 text-xs font-bold text-slate-800">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white p-5 sm:p-6 rounded-2xl border border-stone-200 shadow-sm space-y-3 text-center">
              <img
                src={institute.images.directorImage}
                alt="Director"
                className="w-28 h-28 sm:w-32 sm:h-32 rounded-full object-cover mx-auto border-4 border-[#0F2038] shadow"
                loading="lazy"
              />
              <div>
                ...
                <p className="text-xs font-bold text-[#8B1E26]">
                  Founder & Managing Director (B.Tech, IIT Bombay)
                </p>
              </div>
              <p className="text-xs text-slate-600 italic bg-stone-50 p-3 rounded-xl border border-stone-100 font-normal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          <div className="bg-white p-5 sm:p-6 rounded-2xl border border-stone-200 shadow-xs space-y-2">
            <Target className="w-6 h-6 text-[#8B1E26]" />
            <h3 className="font-extrabold text-sm sm:text-base text-slate-900">Our Mission</h3>
          ...
          <div className="bg-white p-5 sm:p-6 rounded-2xl border border-stone-200 shadow-xs space-y-2">
            ...
            <h3 className="font-extrabold text-sm sm:text-base text-slate-900">Our Core Value</h3>
            <p className="text-xs text-slate-600 leading-relaxed font-normal">
          ...
          <div className="bg-white p-5 sm:p-6 rounded-2xl border border-stone-200 shadow-xs space-y-2">
            ...
            <h3 className="font-extrabold text-sm sm:text-base text-slate-900">Parent Partnership</h3>
            <p className="text-xs text-slate-600 leading-relaxed font-normal">
